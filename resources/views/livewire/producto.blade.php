<div>
    ...
    @include('livewire.modalcrearproducto')
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    <a class="btn2 btn-red mb-1 py-2" wire:click="$emit('delethis',{{$onlyproduct->id}})">
    ...
    @endif
    {{-- {{-- @include('livewire.modalverproducto') --}}
    @include('livewire.modaleditarproducto')
    <script>
